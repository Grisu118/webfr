...
public class BasicListener implements ServletContextListener,
    ...
    public BasicListener() {
        logger.debug("BasicListener init");
    }
    ...
    public void contextInitialized(ServletContextEvent sce) {
      /* This method is called when the servlet context is
        ...
        */
        Object s = sce.getServletContext().getInitParameter("mode");
        sce.getServletContext().setAttribute("questionnaireRepository", QuestionnaireRepository.getInstance());
        if (Objects.equals(s, "test")) {
            QuestionnaireInitializer.createQuestionnaires();
        }
        logger.debug("Mode is " + s);
